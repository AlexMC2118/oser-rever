 ...
 *
 * Tabulación y adaptación:
 *  1) Alejandro Moreno Camacho
 */
(function(b){
  ...
  function a(ac,ae,G){
    ...
    S.width(av.width);
    if(window.innerWidth < 800){S.width(av.width/2)}//Comprobamos anchura de pantalla para no añadir o si la pagina
    S.height(av.height);
  ...
  if(av.overlays){
    if(window.innerWidth > 800){ak=b('<div class="b-overlay b-overlay-prev b-prev" title="Previous Page"></div>').appendTo(S)}
    if(window.innerWidth > 800){al=b('<div class="b-overlay b-overlay-next b-next" title="Next Page"></div>').appendTo(S)}
    T=S.find(".b-overlay");
    if(b.browser.msie){
  ...
  f.click(function(i){
    ...
    if(window.innerWidth > 800){
      ...
      ao.gotoPage(av.curr+1);
    }
  });
  ers=S.find(".enviarresultado");
  ers.click(function(i){
    i.preventDefault();
    if(window.innerWidth > 800){
      ao.next();
    }
  ...
  e.click(function(i){
    if(av.curr != 0 && av.curr != 4 && av.curr != 6 && av.curr != 8 ){ // colocamos el if para que no inicie en las paginas correspondientes
      i.preventDefault();
      ao.next();
    }
  });
  d.click(function(i){
    if(av.curr != 6 && av.curr != 8){// colocamos el if para que no inicie en las paginas correspondientes
      i.preventDefault();
      ao.prev();
    }
  });
  if(av.hovers){
    e.hover(function(){
      if(!ad&& av.curr != 0 && av.curr != 4 && av.curr != 5 && av.curr != 6 && av.curr != 7 && av.curr != 8 && av.curr+2<=av.pTotal-2){ // colocamos av.curr != 0 && 4 para que no inicie en la primera y 6 pag
    ...
    d.hover(function(){
      if(!ad && av.curr != 6 && av.curr != 7 && av.curr != 8 && av.curr-2>=0){
  ...
  function h(){
    ...
    if(av.closed){
      b(ap).attr({title:av.closedFrontTitle||"Beginning",rel:av.closedFrontChapter||"Beginning of Book"}).prependTo(A);
      A.children().last().attr({title:av.closedBackTitle||"End",rel:av.closedBackChapter||"End of Book"});
      A.append(ap);
    }
    if(av.direction=="LTR"){
      I=0;
  ...
  function aa(){
    ...
    if(av.curr-2>=0){
      ...
      if(window.innerWidth >800){S.find(".b-page-"+(av.curr-1)).addClass("b-p0").show()};//Comprobamos anchura de pantalla para no añadir o si la pagina
    }
    S.find(".b-page-"+(av.curr)).addClass("b-p1").show();
    if(window.innerWidth >800){S.find(".b-page-"+(av.curr+1)).addClass("b-p2").show()};//Comprobamos anchura de pantalla para no añadir o si la pagina
    if(av.curr+3<=av.pTotal){
      S.find(".b-page-"+(av.curr+2)).addClass("b-p3").show();
      if(window.innerWidth >800){S.find(".b-page-"+(av.curr+3)).addClass("b-p4").show()}; //Comprobamos anchura de pantalla para no añadir o si la pagina
    }
    F=S.find(".b-pN");
    ab=S.find(".b-p0");
    Z=S.find(".b-p1");
    ...
    c.stop().css({left:0});U.css({left:av.pWidth,width:av.pWidth,height:av.pHeight});
    if(av.curr+3<=av.pTotal){
      W.after(ab.detach());
      Z.after(U.detach());
    }
  ...
  function Q(j,i,p){
    if(i&&j>2){
      ...
      S.find(".b-page-"+av.curr).addClass("b-p3").show().stop().css({left:av.pWidth*2,width:0,height:av.pHeight,paddingLeft:0});
      S.find(".b-page-"+(av.curr+1)).addClass("b-p4").show().css({left:av.pWidth,width:av.pWidth,height:av.pHeight});
      S.find(".b-page-"+av.curr+" .b-wrap").show().css({width:av.pWidth-(av.pagePadding*2),height:av.pHeight-(av.pagePadding*2),padding:av.pagePadding});
      S.find(".b-page-"+(av.curr+1)+" .b-wrap").show().css({width:av.pWidth-(av.pagePadding*2),height:av.pHeight-(av.pagePadding*2),padding:av.pagePadding});
      W=S.find(".b-p3");U=S.find(".b-p4");c=S.find(".b-p3 .b-wrap");aq=S.find(".b-p4 .b-wrap");
      if(C){
      ...
      if(!i&&j>2){
        ...
        S.find(".b-page-"+av.curr).addClass("b-pN").show().css({left:0,width:av.pWidth,height:av.pHeight});
