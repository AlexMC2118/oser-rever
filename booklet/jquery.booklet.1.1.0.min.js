...
(function(b){
  ...
  e.click(function(i){
    if(av.curr != 0 && av.curr != 4 && av.curr != 6){ // colocamos el if para que no inicie en la primera pag
      i.preventDefault();
      ao.next();
    }
  });
  ...
  if(av.hovers){
    e.hover(function(){
      if(!ad&& av.curr != 0 && av.curr != 4 && av.curr != 5 && av.curr != 6 && av.curr+2<=av.pTotal-2){ // colocamos av.curr != 0 && 4 para que no inicie en la primera y 6 pag
